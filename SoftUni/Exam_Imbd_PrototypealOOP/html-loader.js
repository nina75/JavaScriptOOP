    ...
    function loadHtml(selector, data) {
        ...
        genresUl.addEventListener('click', function(ev) {
            ...
            if(ev.target.tagName === 'LI') {
                ...
                //var movieNodes = Array.prototype.slice.call(moviesHtml.childNodes);//тва не бачка, ама защо???
                ...
                movieNodes.forEach(function(node) {
                    ...
                    node.addEventListener('click', function(ev) {
                        ...
                        //detailsContainer.innerHTML = ''; - това е по-бавно от горното, затова не изполв този начин
